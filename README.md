...
# ДЗ №11
Что было сделано:
- Настроено разворачивание приложения в Vagrant
- nginx проксирует приложение на 80 порт
- Созданы тесты для роли db
- Добавлен тест, проверяющий слушается ли порт mongodb + содержится ли порт в конфиге бд
- Проверено, что тесты падают при неправильной конфигурации
- В плейбуки, используемые пакером для создания образов добавлено использование ролей
